 ...
 *
 * <p>Отвечает за создание, обновление, удаление, получение иерархических объектов,
 * а также назначение и снятие ответственных пользователей. Формирует путь объектов
 * и предоставляет методы работы с текущим аутентифицированным пользователем.</p>
 *
 * <p>Ответственность:</p>
 * <ul>
 *     <li>CRUD-операции объектов</li>
 *     <li>Поддержка иерархии объектов (parent/children)</li>
 *     <li>Назначение и удаление ответственных пользователей</li>
 *     <li>Формирование пути объекта (breadcrumbs)</li>
 *     <li>Работа с текущим аутентифицированным пользователем</li>
 * </ul>
 *
 * <p>Сервис не управляет представлением и авторизацией на уровне ролей.</p>
 */
@Slf4j
@Service
...
public class ObjectService {
    ...
    /** Mapper для преобразования между DTO и сущностями объектов. */
     ...
     * Удаляет объект.
     *
     * <p>Удаление невозможно, если объект имеет дочерние элементы.</p>
     *
     * @param id идентификатор объекта
     * @throws ObjectNotFoundException если объект не найден
     ...
     *
     * @return список объектов текущего пользователя
     */
    ...
    /**
     * Возвращает путь объекта от корня до текущего элемента.
     *
     * @param id идентификатор объекта
